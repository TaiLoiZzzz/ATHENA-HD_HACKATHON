    ...
    <div className={`bg-white rounded-xl shadow-lg p-6 ${className}`}>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Lời khuyên tối ưu cho rank {userProfile?.rank}
              </p>
            </div>
          </div>
      ...
      <div className="mt-6 bg-gradient-to-r from-purple-100 to-pink-100 rounded-lg p-4">
        ...
        <p className="text-sm text-gray-700">
          Dựa trên phân tích rank {userProfile?.rank}, lịch sử giao dịch và xu hướng thị trường, 
          AI đã chọn {recommendations.length} sản phẩm tối ưu nhất để giúp bạn tối ưu hóa token earnings.
        </p>
      </div>
    </div>
  );
